...
class GarageTest {
    ...
    @Test
    void testGetAvailableSpaces() throws Exception {
    ...
    @Test
    void testGetOccupiedSpaces() throws Exception {
    ...
    @Test
    void testDecrementAvailableSpaces() throws Exception {
    ...
    @Test
    void testIncrementAvailableSpaces() throws Exception {
